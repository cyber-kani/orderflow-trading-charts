<!--- Heatmap Module - Order book visualization using IQFeed data --->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Order Book Heatmap - ES Futures</title>
    <style>
...
<body>
    ...
    <script>
        ...
        function updateStats(snapshot) {
            ...
            document.getElementById('totalBidVol').textContent = snapshot.totalBidVol.toLocaleString();
            document.getElementById('totalAskVol').textContent = snapshot.totalAskVol.toLocaleString();
        ...
        function renderHeatmap() {
            ...
            // Update scale label
            document.getElementById('scaleMaxLabel').textContent = maxVol.toLocaleString();
        ...
        function handleMouseMove(e) {
            ...
            if (heatmapHistory.length > 0) {
                ...
                var volInfo = '';
                if (bidVol > 0) volInfo = '<span style="color:#22c55e">Bid Vol: ' + bidVol + '</span>';
                else if (askVol > 0) volInfo = '<span style="color:#ef4444">Ask Vol: ' + askVol + '</span>';
